...
namespace OTC_API_SIGN_SDK
{
  ...
  public partial class Signer
  {
    ...
    public HttpWebRequest Sign(HttpRequest r)
    {
      ...
      {
        req.Headers.Add(HeaderSecurityToken, securityToken);
      }
      return req;
    }
    ...
    public HttpRequestMessage SignHttp(HttpRequest r)
    {
      ...
      {
        var contentType = r.headers["content-type"] ?? "application/json";
        req.Content = new StringContent(r.body, Encoding.UTF8, contentType);
      }
      var time = r.headers.GetValues(HeaderXDate);
      DateTime t;
      if (time == null)
